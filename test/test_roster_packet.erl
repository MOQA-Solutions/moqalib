...
init() ->
	file:set_cwd("../src"),
	Updates =#{
		list_to_binary("user1") => ?BINON,
		list_to_binary("user2") => ?BINUNDEFINED,
		list_to_binary("user3") => {{2022 , 10 , 01} , {02 , 40 , 36}}
		},

	Roster =#roster{
		updates = Updates
		},
	EncodedData = moqalib_encoder:encode_packet(Roster),
